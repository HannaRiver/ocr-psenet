...
if __name__ == '__main__':
    ...
    if "single_test" == flag:
        #args.resume = "checkpoints/ocr_resnet50_bs_4_ep_200_2020-01-18_18_07_56_pretrain_ic17/checkpoint47.pth.tar"
        args.resume = "checkpoints/ocr_resnet50_bs_4_ep_200_2020-03-24_21_51_23_pretrain_ic17/checkpoint30.pth.tar"
        ...
        with open("/data_1/software/PseNet_1/checkpoints/ocr_resnet50_bs_4_ep_200_2020-03-24_21_51_23_pretrain_ic17/batch_acc.txt", 'w') as fres:
            fres.write("Acc.        IOU.\n")
            best_acc = 0.0 
            best_iou = 0.0 
            best_model = ""
            with open("/data_1/software/PseNet_1/checkpoints/ocr_resnet50_bs_4_ep_200_2020-03-24_21_51_23_pretrain_ic17/model_list.txt") as fr:
