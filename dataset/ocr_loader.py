...
ocr_root_dir = '/data_1/data/det_train_dataset/'
ocr_train_data_dir = ocr_root_dir + 'train/text_image/'
ocr_train_gt_dir = ocr_root_dir + 'train/text_label_curve/'
ocr_test_data_dir = ocr_root_dir + 'test/text_image/'
ocr_test_gt_dir = ocr_root_dir + 'test/text_label_curve/'
...
class OCRLoader(data.Dataset):
    def __init__(self, is_transform=False, img_size=None, kernel_num=7, min_scale=0.4):
        ...
        data_dirs = [ocr_train_data_dir]
        gt_dirs = [ocr_train_gt_dir]
